...
// currency itself arrives with the figures now: this file used to label every
// row with DEFAULT_CURRENCY, so a payload in another accounting currency was
// printed under the wrong symbol - the figure right and the name of it wrong.
