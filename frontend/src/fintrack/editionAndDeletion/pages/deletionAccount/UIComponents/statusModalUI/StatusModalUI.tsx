...
type StatusModalUIPropType={
 ...
 // Generated by the dialog around this one, which is the element that carries
 // the role and therefore the element the heading has to name.
 titleId:string;
}
...
// ============================
 return (
/* No role here any more. RTAConfirmationModal wraps this and declares itself
   the dialog -- as alertdialog precisely when this component is what it holds.
   A dialog nested in a dialog is not a structure a screen reader can report. */
