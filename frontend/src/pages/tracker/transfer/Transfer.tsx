...
import { transferSchema } from '../../../fintrack/validations/zod_schemas/trackerMovementSchema.ts';
import { MovementValidatedDataType } from '../../../fintrack/validations/types.ts';
