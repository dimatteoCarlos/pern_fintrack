...
import useFormManager from '../../../fintrack/hooks/useFormManager.ts';
...
import { incomeSchema } from '../../../fintrack/validations/zod_schemas/trackerMovementSchema.ts';
import { IncomeValidatedDataType } from '../../../fintrack/validations/types.ts';
  ...
  async function onSaveHandler(e: React.MouseEvent<HTMLButtonElement>) {
    ...
    try {
      ...
      if (typeof newTotalBalance === 'number') {
        setAvailableBudget(newTotalBalance); // 🔥 Éxito: Llamada segura dentro del handler
      }
