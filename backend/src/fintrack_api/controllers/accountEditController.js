// backend/src/fintrack_api/controllers/accountEditController.js (NUEVO ARCHIVO)
 ...
 * Detemrines which tables to update(user_accounts and the specific table).
 */
...
//specific table fields by account type
   ...
   // 3. Determine specific fields per account type
   switch (account_type_name) {
    ...
    case 'debtor':
     ...
     specificFields.account_name=`${capitalize(debtor_lastname.trim()),capitalize(debtor_name.trim())}`
     break;
   }
